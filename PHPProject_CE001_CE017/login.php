...
if ($_SERVER['REQUEST_METHOD'] == "POST")
{
    ...
    {
        $err = "Please enter username or password whichever is blank";
    }
    else{
  ...
  <div class="wrapper fadeInDown">
    <div id="formContent">
      ...
      <form action="<?php $PHP_SELF?>" method="post">
        ...
        <input type="password" name="password" id="password" type="password" class="fadeIn third" placeholder="password"
          required><br><br>
